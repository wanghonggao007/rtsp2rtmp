...
func main() {
	...
	flag.StringVar(&rtspUrl, "rtspUrl", "rtsp://admin:root1234@192.168.8.64:554/h264/ch1/main/av_stream", "")
	flag.StringVar(&rtmpUrl, "rtmpUrl", "rtmp://127.0.0.1:1935/live", "")
	flag.StringVar(&streamName, "av_stream", "3333", "")
	flag.Parse()
	fmt.Println("======================")
